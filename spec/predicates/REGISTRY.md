...
- **Registered here.** This host is the naming authority for the URI and
  nothing more. The normative field definitions are published by the
  implementation that emits the type and are not vendored here. A verifier must
...
The three entries above are registrations, not specifications. Their field
